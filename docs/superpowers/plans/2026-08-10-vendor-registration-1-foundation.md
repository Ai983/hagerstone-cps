...
SELECT vendor_type,
       count(*) FILTER (WHERE is_mandatory AND active) AS mandatory_docs
FROM cps.cps_vendor_document_rules GROUP BY 1 ORDER BY 1;
-- Expected: company 8, individual 4, proprietor 7
```
