...
const NAV = [
  ...
  { title: "Kanban Board", url: "/kanban", icon: KanbanSquare, roles: ["procurement_executive","procurement_head","it_head","management","auditor","finance","accounts_team"] },
  ...
  { title: "GRN Approvals", url: "/grn-approvals", icon: FileCheck, roles: ["procurement_head","it_head","management"] },
