...
export default function Quotes() {
  ...
  const openReview = async (quoteId: string) => {
    ...
    // Load file URL if available (bucket is private — use signed URL)
    ...
    if ((qRow.parse_status === "approved" || qRow.parse_status === "parsed" || qRow.parse_status === "reviewed" || qRow.parse_status === "needs_review") && liRows.length > 0) {
      ...
      if (Array.isArray(prevAdvances)) {
        setAdvancePayments(prevAdvances.map((a: any, i: number) => ({
          id: String(i),
    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 flex-wrap">
        ...
        <Select value={statusFilter} onValueChange={(v) => setStatusFilter(v as StatusFilter)}>
          ...
          <SelectContent>
            <SelectItem value="all">Total Quotes</SelectItem>
